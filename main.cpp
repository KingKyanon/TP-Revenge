...
int main()
{
    ...
    int opciones = 0,  contadorjuego=-1, contadorturno = 0, dadostockj1 = 0, dadostockj2 = 0,valorobjetivoronda = 0, cuentadados = 0, dadoapasar = 0;
    char opciones2, dadoapasarpv [2];
    ...
    while (opciones != 4)
    {
        ...
        opciones = 0;
        cout << "###############################" << endl;
        cout << "Seleccione que desea realizar: " << endl << "1 - Jugar" << endl << "2 - Estadisticas" << endl << "3 - Creditos" << endl << "4 - Salir" << endl << "Seleccion: ";
       ...
       switch (opciones)
       {
           ...
           case 1:
            ...
            do
            {
                ...
                contadorturno = 0;
                verificador = false;
                lanzardado12c (DADOS12, MtiradasD12, contadorjuego, contadorturno);
                cout << endl << "------------";
            ...
            for (int i=0; i<RONDAS; i++)
            {
                ...
                cout << endl << "Presione enter para continuar";
                getchar();
                lanzardado6c (MtiradasD6J1, dadostockj1, contadorjuego, contadorturno);
                ...
                for (int y=0; y<dadostockj1; y++)
                {
                    ...
                    {
                        cin >> dadoapasarpv;
                        verificador = validarnumero (dadoapasarpv);
                        if (verificador == false)
                        {
                            cout << endl << "No parecia necesario aclararlo, pero solo puede ingresar numeros. Intentelo nuevamente" << endl;
                        }
                    } while (verificador == false);
                    dadoapasar = atoi (dadoapasarpv);
                    switch (verificadadoapasar(dadostockj1, dadoapasar, Vdadosasumar, MtiradasD6J1, contadorjuego, contadorturno, valorobjetivoronda, cuentadados ) )
                    {
                    case 1:
                        cout << endl << "no deberias haber ingresado un numero de dado mayor a la cantidad de dados que tenias. PERDISTE EL TURNO";
                        y = dadostockj1;
                        for (int r=0; r<DADOSMAX; r++)
                        {
                            Vdadosasumar [r] = 0;
                        }
                    break;
                ...
                if (i < RONDAS)
                {
                    ...
                    cout << endl << "Ronda N°: " << contadorturno << endl;
                    cout << endl << Vjugador1 [contadorjuego] << " - puntaje: " << VpuntajeJ1 [contadorjuego] << " - Dados de Stock: " << dadostockj1;
                    cout << endl << endl << Vjugador2 [contadorjuego] << " - puntaje: " << VpuntajeJ2 [contadorjuego] << " - Dados de Stock: " << dadostockj2;
                    ...
                    getchar();
                    lanzardado6c (MtiradasD6J2, dadostockj2, contadorjuego, contadorturno);
                    // mostrar valores de los dados
                    cout << endl << "resultados: ";
                    ...
                    for (int y=0; y<dadostockj2; y++)
                    {
                        ...
                        dadoapasar = atoi (dadoapasarpv);
                        switch (verificadadoapasar(dadostockj2, dadoapasar, Vdadosasumar, MtiradasD6J2, contadorjuego, contadorturno, valorobjetivoronda, cuentadados ) )
                        {
                        case 1:
                            cout << endl << "no deberias haber ingresado un numero de dado mayor a la cantidad de dados que tenias. PERDISTE EL TURNO";
                            y = dadostockj2;
            ...
            case 3:
                cout << "############################################" << endl;
                cout << "Tecnicatura Universitaria en Programacion UTN gral. pacheco." << endl << "Laboratorio de Comnputacion 1, ciclo 2021, segundo cuatrimestre." << endl << "INTEGRANTES DEL GURPO 9:" << endl << endl << "Aguilera, Orlando / Legajo 25411" << endl << endl << "Bianco Sausto, Alejandro J / Legajo 25648" << endl << endl << "Callegari, Sebastian / Legajo 24163" << endl << endl << "Rojas, Julieta / Legajo 21608" << endl;
                cout << "############################################" << endl;
            break;
        //4- Salir
            case 4:
